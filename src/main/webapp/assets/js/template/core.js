...
jQuery(document).ready(function($){
    ...
    $('.dropmenu').click(function(e){
        ...
        /* ADD PSR*/
        if($(this).find('.label>i').hasClass('fa-plus')) {
            $(this).find('.label>i').removeClass('fa-plus');
            $(this).find('.label>i').addClass('fa-minus');
        } else {
            $(this).find('.label>i').removeClass('fa-minus');
            $(this).find('.label>i').addClass('fa-plus');
        }
